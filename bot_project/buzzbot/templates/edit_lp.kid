	...
	<fieldset>
	  ...
	  <table class = "help_table">
	    <tbody>
	      ...
	      <tr><td>Please check at least one search, and add as many others as you would like.</td></tr>
	      <tr><td>The "target word" identifies interesting content - typically the name of the client/product.</td></tr>
	      <tr><td>Sharing options give other users access to your search specifications and results.</td></tr>
	      <tr><td>If you edit a search belonging to another, you will be working on your own copy.</td></tr>
	      <tr><td>  </td></tr>
