...
>
   ...
   <!-- Outer container table --> 
	...
	<tr class = 'edit_search_header'>
	  <td >
	    <h3> 
	      ...
	      <img border="0" src="/static/images/spacer_khaki.JPG" width="70" height="1" /> 
	      Delete Search? 
	      <img border="0" src="/static/images/spacer_khaki.JPG" width="70" height="1" /> 
	...
	<!-- Second row has topic heading --> 
	  <tr><td> <h1>You have chosen to delete search "$value.name"</h1> </td>  </tr>
	 <tr><td><h1>This will delete this search and all content associated with it; it can't be undone.</h1> </td></tr>
	  <tr>
