...
DATABASE_USER = 'pat'             # Not used with sqlite3.
DATABASE_PASSWORD = 'dogma123'         # Not used with sqlite3.
...
'''
this code works for a mysql-only app
...
MEDIA_ROOT = '/home/pat1/workspace/djangoproj/'
...
INSTALLED_APPS = (
	...
	#'djangoproj.csc',       #concept net
	#'djangoproj.psycopg2',  #concept net's orm
...
#this is the default url when no other direction is provided
LOGIN_URL = '/login/'