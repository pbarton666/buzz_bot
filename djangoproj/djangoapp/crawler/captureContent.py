...
ancestorDepth = 1   #layers of nested, hierarchal url parse tree to use searching for dates
...
class CaptureContent():    
   ...
   def makeAndCleanSoup(self, rawData):
      ...
      #these will be used to strkip out the html unicode analogies
